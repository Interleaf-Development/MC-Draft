...
const chapterAliases = { authoring: 'library', protection: 'library', operations: 'system', billing: 'system' };
...
document.querySelector('meta[name="description"]').content=t('MathConcept product scope: curriculum management, digital teaching, centre operations and proposed delivery terms.','MathConcept 系統建議書，涵蓋數碼學習、教材管理、中心營運，以及建議的交付範圍和安排。');
...
main.insertAdjacentHTML('beforeend',chapters.slice(1).map((c,i)=>chapterHTML(c,i+1)).join('')+`<footer class="document-footer"><img src="assets/mathconcept-logo.png" alt="MathConcept"><div><strong>${t("Product scope and delivery proposal","系統功能及交付建議")}</strong><p>${t("Draft · 23 September 2026","初稿 · 2026年9月23日")}</p></div><a href="#vision">${t("Back to the beginning ↑","返回開首 ↑")}</a></footer>`);
