...
detail('Creating and approving new materials',`<p>Build a material-editing platform similar to Wix or Canva, where teachers can create and edit worksheets and interactive exercises by dragging and dropping. The platform can gradually add mathematical-symbol entry and formula editing with tools such as MathType. AI can also generate content, layouts, Python code or custom HTML interactive components for teachers to check and adjust. This gives teachers more freedom to design layouts and turn the same material into online interactive exercises or games, while retaining printing. Where needed, materials can also be exported as PDF or Word documents to fit existing workflows. AI can help generate questions, hints, solutions and interactive content for teachers to review and edit.</p>`)+
 ...
 feature('Billing and bank reconciliation', 'Billing follows the sequence: invoice → parent payment proof → staff review and approval → receipt. Bank statements are then checked to confirm whether actual credits match the receipt records. Receipt issuance and bank reconciliation have separate progress records, helping staff follow up unfinished work. AI assists staff with payment-proof review, receipt issuance and final reconciliation.',
 ...
 detail('Two-month tuition',`<p>The fee is HK$2,000 for a nominal eight-lesson package valid for two calendar months. Students can have different periods, such as September–October or October–November. Depending on the existing weekly timetable, a period may contain seven, eight or nine lessons, with no additional fee or refund. The teaching schedule averages 48 weeks annually.</p>`)+
 ...
 detail('Parent payments',`<p>Parents can view the amount due and payment deadline, and copy the FPS payment details. After payment, they upload proof for staff to review and approve before a receipt is issued.</p>`)+
 ...
 detail('Receipt amendments after timetable changes',`<p>An approved timetable change updates the actual lesson dates and produces an amended receipt. The amendment retains the original payment date, receipt date and paid amount, and separately records the actual amendment date and reason. The original and all previous receipt versions remain available for review.</p>`)+
 detail('Final reconciliation',`<p>After a bank statement is uploaded, match bank credits to issued receipts and list records without a corresponding match, extra payments and uncertain matches. Prevent a transaction from being counted twice or the same credit from confirming more than one payment. Staff follow up unexplained differences.</p>`)+
 detail('Dates and reconciliation records',`<p>Record the parent’s payment date, proof submission date, receipt issue date and bank posting date separately, without assuming they are the same. Show receipt progress and bank reconciliation progress separately; an issued receipt may still await bank reconciliation.</p>`)+
 ...
 detail('Checks before live use',`<p>Confirm bank-record formats, matching conditions and payment-allocation rules before live use. Payment checks and automatic invoicing in the demonstration are simulated and must be validated against representative real records.</p>`))},
 ...
 {id:'rollout',title:'Delivery, pilot and acceptance',heading:'Delivery, pilot and acceptance',intro:'Choose a centre for a pilot using representative materials, devices and everyday workflows. Both parties assess the results against agreed acceptance criteria before deciding the scope and order of the next rollout stage.',body:
  ...
  detail('Pilot acceptance schedule',table(['Area','Acceptance example'],[
   ...
   ['Billing','Apply each student’s two-calendar-month period and HK$2,000 nominal eight-lesson fee. The usual seven, eight or nine lessons in the period do not alter the fee; the schedule averages 48 weeks annually. Invoice on the 20th before the next period and make payment due on the following month’s 20th. Regular timetable changes that increase or reduce lessons require an admin decision. Amended receipts retain the original payment and receipt dates, show the amendment date and preserve previous versions. Payment proof requires staff approval before a receipt is issued; only first-enrolment approval activates enrolment. Staff cannot close the popup or navigate away during saving. Failed or uncertain reviews remain recoverable without duplicate receipts. Bank reconciliation identifies differences and double allocations.'],
...
export const references = {
 ...
 assumptions:{title:'Open decisions & responsibilities',body:
  `<p class="reference-lead">These decisions shape the delivery scope, acceptance measures and cost. MathConcept and the delivery team resolve them during discovery and the pilot.</p><h3>Materials</h3>${list([
   ...
   'Confirm each student’s two-calendar-month billing period, the teaching calendar averaging 48 weeks annually, and approval and make-up credit decisions for regular timetable changes. Agree receipt wording, the evidence staff review and first-enrolment activation checks. Keep receipt issuance distinct from bank reconciliation.',
