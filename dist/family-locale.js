...
const words = {
  ...
  'Leave has already been recorded for this lesson.':'這節課堂已登記請假。',
  'Leave can only be recorded for an upcoming, unattended lesson.':'只可為尚未出席的未來課堂申請請假。',
  'This make-up has already been arranged.':'這次補堂已安排，請聯絡中心更改。',
  'Choose up to three preferred dates.':'最多可提供 3 個意願日期。',
  'Choose valid preferred dates.':'請選擇有效的意願日期。',
  'Choose today or a future preferred date.':'請選擇今天或之後的意願日期。',
  'Choose different preferred dates.':'請選擇不同的意願日期。',
  'Enter a valid preferences note.':'請填寫有效的補堂備註。',
