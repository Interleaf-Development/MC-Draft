...
const CACHE_NAME = CACHE_PREFIX + 'v49-proposal-real-demo';
...
const PRECACHE = [
  '/proposal/app.js', '/proposal/content.js', '/proposal/demos.js', '/proposal/styles.css', '/proposal/assets/mathconcept-logo.png',
