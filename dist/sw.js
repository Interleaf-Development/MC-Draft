...
const CACHE_NAME = CACHE_PREFIX + 'v89-proposal-student-materials';
...
const PRECACHE = [
  '/game1/engine.js', '/game1/renderer.js', '/game1/game.js', '/game1/styles.css',
  '/proposal/app.js', '/proposal/content.js', '/proposal/content.zh-HK.js', '/proposal/locale.js', '/proposal/solutions.js', '/proposal/smartpen-content.js', '/proposal/smartpen-flow.js', '/proposal/smartpen-writing-demo.js', '/proposal/shared-knowledge.js', '/proposal/structure.js', '/proposal/demos.js', '/proposal/styles.css', '/proposal/assets/mathconcept-logo.png',
  ...Object.keys(shells), '/entry-points.js', '/branch-config.js', '/demo-context.js',
  '/handbook.js', '/handbook-ui.js', '/handbook.css', '/student-work.js', '/student-binder-ui.js', '/student-binder.css', '/student-focus.css', '/p6-curriculum.js', '/p3-curriculum.js', '/progress-records.js', '/primary-lower-records.js', '/primary-upper-records.js', '/secondary-kindergarten-records.js', '/teacher-progress.js', '/teacher-progress-ui.js', '/teacher-progress.css',
  ...
  '/brand/mathconcept-logo.png', '/brand/mathconcept-m.png', '/parent/manifest.webmanifest', '/student/manifest.webmanifest', '/hh/parent/manifest.webmanifest', '/hh/student/manifest.webmanifest', '/icons/mathconcept-192.png', '/icons/mathconcept-512.png', '/icons/mathconcept-apple-touch.png', '/icons/mathconcept-favicon.png',
