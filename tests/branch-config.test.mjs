...
function open(config, saved) {
  return vm.runInNewContext(startup + persist + '\n({get:()=>state,save:value=>{state=value;persist();}})', {
    ...
    seedCentreVolume() {}, seedTeacherSchedules() {}, seedBusyAfternoons() {}, normalizeParentLeave() {}, normalizeStaffLeave() {}, normalizeConversations() {}, normalizeBillingAutomation() {}, normalizeP6Progress() {},
