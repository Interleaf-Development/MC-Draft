...
- **Admin:** right-click a student card (or press **Shift+F10** when focused) to set its cell colour. **Green = New student**; blue, yellow, purple and pink are also available, with **Default** to clear it. Colours are saved per lesson in this browser and follow a dragged/moved booking.
